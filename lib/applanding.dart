import 'package:applanding/data/general_data.dart';
import 'package:applanding/others/responsive_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Container(
          child: Column(
            children: <Widget>[OneHeader(), Bottom(), BelowBottom(), Footer()],
          ),
        ),
      ),
    );
