import 'package:applanding/model/app_feature_model.dart';
import 'package:applanding/model/feature_tile_model.dart';
import 'package:applanding/model/testimonial_model.dart';
...
String appHeading = "Fastest & Easiest Sticker and Meme Maker";
String appDescription = "Struggling to create memes and whatsapp stickers end here MemeEr is a Fast & Easy Meme & Sticker Maker\nMemeEr Download Now!";

/// Two
String maintitle = "Create, Integrate, and Share";
String maindescription = "MemeEr is a meme & sticker making app that gives you the ability to create and share your memes & stickers in an easy, quick and painless way.";

String closingTitle = "Making Stickers/Memes Was Never This EASY";
...
String aboutUsUrl = "https://www.twitter.com/mastersam_/";
...
List<AppFeatureModel> getAppFeatures(){
  ...
  appFeatureModel.setFeatureTitle("Making Sticker and Meme Was Never So Easy");
